...
for weights in ['uniform', 'distance']:
    ...
    res = clf.predict(train_features)


# clf = svm.SVC(C=19.0, cache_size=2000, class_weight=None, coef0=10000, degree=6, gamma=10, kernel='rbf', max_iter=-1, probability=False, tol=0.001, verbose=True)
# clf.fit(train_features, train_values) 
# res = clf.predict(train_features)
...
predictions_file = csv.writer(open("../../results/nn-train-v1.csv", "wb"))
