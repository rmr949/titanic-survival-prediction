...
clf = svm.SVC(C=19.0, cache_size=2000, class_weight=None, coef0=10000, degree=6, gamma=150, kernel='rbf', max_iter=-1, probability=False, tol=0.001, verbose=True)
...
predictions_file = csv.writer(open("svm-predict-test.csv", "wb"))
