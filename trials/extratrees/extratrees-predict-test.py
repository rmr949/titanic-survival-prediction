...
csv_file_object = csv.reader(open('../../data/train-original.csv', 'rb')) #Load in the training csv file
...
test_file_object = csv.reader(open('../../data/test-original.csv', 'rb')) #Load in the test csv file
...
print 'Training '
forest = ExtraTreesClassifier(n_estimators=1000, max_depth=None, min_samples_split=1, random_state=0)
...
open_file_object = csv.writer(open("../../results/extratrees.csv", "wb"))
